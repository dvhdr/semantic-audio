...
But which words do people use to describe the processing? Here's a list of the most popular words used. I've ignored words used less than eight times to keep the chart small enough, but still it's hard to read beacuse of the massive overuse of *warm* and *bright*.
...
Despite my better judgement, I'm going to press on. Here's an attempt to look at how different words are used to describe compressor settings.
...
I've tried to put it all together in one plot, grouping the most popular words for each of the most popular instruments, all coloured by the effect types used to achieve them. It's not beautiful, but it's kinda useful.
...
Because you gotta have word clouds, here's a cloud of the different terms people use for each type of effect. Note that I've dropped *warm* and *bright* so that the other words get a chance!
...
So what can we conclude? We don't really have enough data to say much more than:
...
5) Oh yeah, and *death to acoustic*! :D

I'd love to get about 10x more data and repeat this analysis. I've mailed this to the Semantic Audio folks, in the hope that the plugins are still gathering data!
